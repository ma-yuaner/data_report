...
class AssetCatalogService:
    ...
    def _base_catalog(self, mode: str) -> dict[str, Any]:
        ...
        for definition in ASSETS:
            ...
            assets.append(item)
        return {"mode": mode, "source": "Hive" if mode == "live" else "配置清单", "generatedAt": datetime.now().astimezone().isoformat(timespec="seconds"), "cacheHit": False, "assets": assets, "metrics": deepcopy(METRICS)}
